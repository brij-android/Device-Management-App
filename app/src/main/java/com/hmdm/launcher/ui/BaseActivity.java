...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void createAndShowEnterDeviceIdDialog( boolean error, String deviceId ) {
        ...
        enterDeviceIdDialogBinding.deviceName.requestFocus();
        enterDeviceIdDialogBinding.deviceName.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean b) {
                if (b){Utils.showKeyboard(view);
                } else Utils.hideKeyboard(view);
            }
        });
        enterDeviceIdDialogBinding.deviceId.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean b) {
                if (b){Utils.showKeyboard(view);
                } else Utils.hideKeyboard(view);
...
//        enterDeviceIdDialogBinding.deviceId.showDropDown();
    ...
    public void showDeviceIdQrCode(View view) {
        String name = enterDeviceIdDialogBinding.deviceName.getText().toString().trim();
        String id = enterDeviceIdDialogBinding.deviceId.getText().toString().trim();
        updateSettingsFromQr("{\n" +
                "\"android.app.extra.PROVISIONING_DEVICE_ADMIN_COMPONENT_NAME\":\"com.hmdm.launcher/com.hmdm.launcher.AdminReceiver\",\n" +
                "\"android.app.extra.PROVISIONING_DEVICE_ADMIN_PACKAGE_DOWNLOAD_LOCATION\":\"https://testmdm.movie-beam.com/files/hmdm-5.26-os.apk\",\n" +
                ...
                "\"android.app.extra.PROVISIONING_ADMIN_EXTRAS_BUNDLE\": {\"com.hmdm.DEVICE_ID\":"+name+",\"com.hmdm.CONFIG\":\"3\",\n" +
                "com.hmdm.GROUP:"+id+",\n" +
//                "com.hmdm.GROUP:1,\n" +
                "\"com.hmdm.BASE_URL\":\"https://testmdm.movie-beam.com\",\n" +
